        ...
        {digits.map((digit, index) => (
          <input
            ...
            className={cn(
              ...
              "h-12 w-11 sm:h-14 sm:w-12 rounded-lg border text-center text-xl font-semibold text-text bg-surface transition-all select-none focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-surface disabled:cursor-not-allowed disabled:opacity-50",
              error
                ? "border-danger focus:border-danger focus:ring-danger"
                : digit
                  ? "border-primary bg-surface focus:border-primary focus:ring-primary"
