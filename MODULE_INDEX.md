...
| L7 | `reading` | Passages, comprehension sets, span answers, reading speed, difficulty estimation | `skill` | `passages`, `passage_questions` | content, questionbank | 3 | PLANNED |
...
| L10 | `writing` | Tasks, drafts, submissions, AI rubric grading, revision history, plagiarism | `skill` | `writing_tasks`, `writing_drafts`, `writing_feedback` | ai, job, content | 3 | PLANNED |
