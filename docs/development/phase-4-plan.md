...
|---|---|---|---|
| P1 | **WO 16** | The spine: namespaces, prerequisite DAG, cycle refusal, Foundation body schemas, read API, seeded topic codes | Path generator returns a valid order for the brief's two example chains |
| P2 | WO 17 | `resource` module: upload and import, validate, status lifecycle | A PDF upload reaches `extracted` |
