...
| P3.1 | 2026-08-15 | Avatar upload lifecycle: `POST /api/v1/me/avatar/upload-intent` presigned upload, `PUT /api/v1/me/avatar` confirmation, magic bytes sniffing, pure-Go image resizing with EXIF GPS stripping, outbox event publishing, and safe old-avatar cleanup |

That closes the first three generated items. Still open in Phase 1: the
