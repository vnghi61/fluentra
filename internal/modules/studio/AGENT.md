...
| `GET` | `/api/v1/me/studio/earnings` | `self` | Creator earnings and financial ledger summary |
| `POST` | `/api/v1/me/studio/payouts` | `self` | Request a creator payout disbursement |
