...
var (
	...
	// ErrCourseNotPurchased is returned when attempting to access a lesson in a course that has not been purchased
	// (BR-STUDIO-05).
	ErrCourseNotPurchased = apperr.New(
		apperr.Forbidden, "COURSE_NOT_PURCHASED",
