...
- Builders in `test/fixtures/builders/mailer.go`
- Golden files in `internal/platform/mailer/testdata/`
<!-- END GENERATED: test-fixtures -->

## Mocks

<!-- BEGIN GENERATED: test-mocks -->
Generated by `moq` into `internal/platform/mailer/mocks/`:
...
```bash
go test ./internal/platform/mailer/...
go test -tags=integration ./internal/platform/mailer/...
go test -run TestXxx -race -v ./internal/platform/mailer/...
```
