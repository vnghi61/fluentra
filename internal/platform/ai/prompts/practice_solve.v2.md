...
temperature: 0.0
description: >-
  Blind-solves an English practice or exam exercise without seeing the answer key,
  to verify item clarity and consensus answer.
inputs:
  - kind: reading_comprehension, listening_comprehension, grammar_tense_choice, or grammar_sentence_transform
