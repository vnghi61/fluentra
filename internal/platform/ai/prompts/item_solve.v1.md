...
temperature: 0.0
description: >-
  Blind-solves an educational item without seeing the answer key,
  to verify item clarity, solvalibility, and consensus answer.
inputs:
  - kind: reading_comprehension, listening_comprehension, grammar_tense_choice, grammar_sentence_transform, or vocab_multiple_choice
...
### If kind is "grammar_tense_choice" or "vocab_multiple_choice":
